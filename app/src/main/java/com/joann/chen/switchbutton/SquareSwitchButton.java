...
public class SquareSwitchButton extends View implements Checkable {
...
//    }
    ...
    public SquareSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public SquareSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SquareSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SquareSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        canvas.drawCircle(x, y, buttonRadius, paint);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SquareSwitchButton view, boolean isChecked);
    }
