...
public class LineSwitchButton extends View implements Checkable {
...
//    }
    ...
    public LineSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public LineSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LineSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LineSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        canvas.drawCircle(x, y, buttonRadius, paint);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(LineSwitchButton view, boolean isChecked);
    }
